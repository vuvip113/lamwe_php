            ...
            <div class="container product_data mt-3">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <hr>
                        <div class="nd_make_web" style="position: relative;">
                            <div class="chu_2" style="font-size: 20px;font-weight: 700;letter-spacing: 2px;position: absolute;padding: 5px;background: #ffffff;top: -10px;left: 20px;border: 2px solid #000000;">
                                Thong tin San Pham</div>
                            <br>
                            <div style="border: 2px solid #000000;padding: 10px;display: flex;"><?= $product['description']; ?>
                            </div>
                        </div>
